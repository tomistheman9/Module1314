...
class ApiProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "products route exists and is a GET route" do
    assert_routing({ path: '/api/api_products', method: :get }, { controller: 'api/api_products', action: 'index' })
  end
  ...
  test "get products with valid restaurant parameter" do
    ...
    get "/api/api_products", params: { restaurant: restaurant.id }
    assert_response :success
    assert_not_nil @controller.instance_variable_get(:@products)
  ...
  test "get products with invalid restaurant parameter" do
    get "/api/api_products", params: { restaurant: 999 }
    assert_response 422
